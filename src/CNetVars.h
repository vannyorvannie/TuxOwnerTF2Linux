...
#include "dt_recv2.h"
//#include <Windows.h> dummy... we use linux around these parts :3
#include <string>
...
#define DYNVAR(name, type, ...) static CDynamicNetvar<type> name( __VA_ARGS__ ) // hashtags are removed. "##" on linux is illegal.
